public class Project {
	...
	public String toString() {
        ...
        if (proName.isEmpty()) {
            proName = proType + " " + Customer.customerName;      //ProjectPersonal.NewCustomer.customerName
     ...
     */
    public static String toTxtFile(String projectDetails) {     //public static String toTxtFile(String projectDetails) {
