...
// Architect:
    public class Architect {       //NewArchitect
         ...
         */
        public Architect(String archName,
                            String archTelNum,
                            String archEmail,
                            String archPhyAdd) {
            Architect.archName = archName;
            Architect.archTelNum = archTelNum;
            Architect.archEmail = archEmail;
            Architect.archPhyAdd = archPhyAdd;
        }
         ...
         */
        public static String toTxtFile(String architectDetails) {   //public static String toTxtFile(String architectDetails) {
