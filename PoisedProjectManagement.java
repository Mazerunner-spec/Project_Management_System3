        ...
        try {
            ...
            switch (newCustomerConfirmation) {
                case 1:
                    ...
                    customerDetails = Customer.toTxtFile(customerDetails);
            ...
            switch (updateChoice) {
                case 1:
                    try {
                        ...
                        if (updatedArchTelNum.equals(Architect.archTelNum)) {       //newArchitect/NewArchitect
                ...
                case 2:
                    try {
                        ...
                        if (updatedBuildTelNum.equals(Contractor.contractorTelNum)) {    
                            System.out.println("Updated Telephone Number matches previous Telephone Number.");
                            throw new InputMismatchException();
                        }
    ...
    public static void finaliseProject(StringBuilder completeProject) {
        ...
        for (String detailLine: copyCompletedProject.toString().split("\n")) {
            ...
            if ("Customer Details".equals(listCustomer.get(0))) {
                // Customer:
                Customer.customerName = listCustomer.get(1);
                Customer.customerTelNum = listCustomer.get(2);
                Customer.customerEmail = listCustomer.get(3);
                Customer.customerPhyAdd = listCustomer.get(4);
            }
            ...
            if ("Architect Details".equals(listArchitect.get(0))) {
                // Architect:
                Architect.archName = listArchitect.get(1);
                Architect.archTelNum = listArchitect.get(2);
                Architect.archEmail = listArchitect.get(3);
                Architect.archPhyAdd = listArchitect.get(4);
            }
           listContractor = new ArrayList < > (Arrays.asList(detailLine.split(", ")));
            if ("Builder Details".equals(detailLine)) {
                // Builder:
                Contractor.contractorName =listContractor.get(1);
                Contractor.contractorTelNum =listContractor.get(2);
                Contractor.contractorEmail =listContractor.get(3);
                Contractor.contractorPhyAdd =listContractor.get(4);
            }
        }
        ...
        try {
            ...
            finaliseWriter.append("______________________________________________________________________\n");
            finaliseWriter.append("Customer Name:.........................  ").append(Customer.customerName);
            finaliseWriter.append("\nCustomer Telephone Number:.............  ").append(Customer.customerTelNum);
